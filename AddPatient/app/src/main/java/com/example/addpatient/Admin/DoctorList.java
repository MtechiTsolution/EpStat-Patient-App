...
public class DoctorList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dataref= FirebaseDatabase.getInstance().getReference("Doctors");
            ...
            protected void onBindViewHolder(@NonNull AdminViewHolder holder, final int position, @NonNull UserHelperClass model) {
                ...
                holder.view.setOnClickListener ( new View.OnClickListener () {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent ( DoctorList.this, DoctorSingleRecord.class );
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        {
            startActivity ( new Intent (DoctorList.this,AdminDashboard.class) );
            finish ();
        }

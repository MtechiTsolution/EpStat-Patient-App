...
import com.example.addpatient.EditPofile;
...
public class AdminEditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar ().setDisplayHomeAsUpEnabled ( true );
        ////init
        SessionManager sessionManager = new SessionManager ( AdminEditProfile.this );
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask( new Continuation<UploadTask.TaskSnapshot, Task<Uri>> () {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AdminEditProfile.this, "Successfully uploaded", Toast.LENGTH_SHORT).show();
                            if (downloadUri != null) {
                                ...
                                databaseReference.child(currentUserID).child("url").setValue(downloadUrl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        if(!task.isSuccessful()){
                                            ...
                                            Toast.makeText(AdminEditProfile.this,"Error : "+error,Toast.LENGTH_LONG).show();
                                        }else{
                            ...
                            // Handle failures
                            // ...
                            Toast.makeText(AdminEditProfile.this,task.getException().getMessage(),Toast.LENGTH_LONG).show();
                            loadingBar.dismiss();
                        }
                    }
                });

...
public class AdminList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dataref= FirebaseDatabase.getInstance().getReference("Admin2");
    ...
    public void addnewAdmin(View view) {
        Intent intent1=getIntent();
        Intent intent=new Intent (AdminList.this,CreateNewAdmin.class);
        intent.putExtra( "email",intent1.getStringExtra( "email" ));
        intent.putExtra( "password",intent1.getStringExtra( "password" ));
        startActivity ( intent );
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent ( AdminList.this, AdminMainActivity.class );
        startActivity ( intent );
        finish();
    }
}
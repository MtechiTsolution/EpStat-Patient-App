...
public class DoctorSingleRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.activity_doctor_single_record );
    ...
    public void DeleteAccount(View view) {
        ...
        builder.setPositiveButton ( "Delete", new DialogInterface.OnClickListener () {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                final SweetAlertDialog pDialog = new SweetAlertDialog ( DoctorSingleRecord.this, SweetAlertDialog.PROGRESS_TYPE );
                pDialog.getProgressHelper ().setBarColor ( Color.parseColor ( "#33aeb6" ) );
                pDialog.setTitleText ( "Removing Doctor..." );
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        firebaseAuth.signInWithEmailAndPassword( intent1.getStringExtra( "email" ),intent1.getStringExtra( "password" ) ).addOnCompleteListener( new OnCompleteListener<AuthResult>() {
                                            ...
                                            public void onComplete(@NonNull Task<AuthResult> task) {
                                                pDialog.dismiss();
                                                Toast.makeText ( DoctorSingleRecord.this, "Data Deleted Successfully", Toast.LENGTH_SHORT ).show ();
                                                Intent intent = new Intent ( DoctorSingleRecord.this, DoctorList.class );
    ...
    private void makePhoneCall(){
        if(ContextCompat.checkSelfPermission(DoctorSingleRecord.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED)
        {
            ActivityCompat.requestPermissions(DoctorSingleRecord.this, new String[] {Manifest.permission.CALL_PHONE}, REQUEST_CALL);

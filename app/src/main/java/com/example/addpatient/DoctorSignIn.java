                    ...
                    if (mAuth.getCurrentUser ().isEmailVerified ()) {
                        ...
                        reference.addValueEventListener ( new ValueEventListener () {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                String statusFromDB = dataSnapshot.child ( FirebaseAuth.getInstance ().getCurrentUser ().getUid () ).child ( "status" ).getValue ( String.class );
                                ...
                                if(statusFromDB.equals( "Accepted" ))
                                {
                                    ...
                                    if(statusFromDB.equals( "decline" ))
                                    {
                                        pDialog.setTitleText ( "verifying from Admin..." );
                                    }
                                    else
                                    {
                                        pDialog.setTitleText ( "Blocked from Admin..." );
                                    }
                                    pDialog.dismiss();
                                    pDialog.setTitleText ( "verifying from Admin..." );
                                    pDialog.show ();

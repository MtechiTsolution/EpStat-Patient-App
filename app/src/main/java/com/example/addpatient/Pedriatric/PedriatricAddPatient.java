...
public class PedriatricAddPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        patientRef = FirebaseDatabase.getInstance ().getReference ( "Pedriatric Add patient" ).child( mauth.getUid() );
    ...
    private void AddPatientRecord() {
        ...
        if (TextUtils.isEmpty ( receivedPatientName )) {
            ...
            SessionManager sessionManager = new SessionManager ( PedriatricAddPatient.this );
            ...
            patientRef .child ( String.valueOf ( Neomaxid+ 1) ).setValue ( model ).addOnCompleteListener ( new OnCompleteListener<Void> () {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful ()) {
                        ...
                        {
                            Toast.makeText ( PedriatricAddPatient.this, ""+i, Toast.LENGTH_SHORT ).show ();
                        ...
                        Intent intent = new Intent ( PedriatricAddPatient.this, MainActivity2.class );
